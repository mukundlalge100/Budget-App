export const DOMstrings = {
  ...
  inputDesciption: document.querySelector(".add__description"),
  ...
  expensePercentages: document.querySelector(".item__percentage"),
  displayDate: document.querySelector(".budget__date")
};
